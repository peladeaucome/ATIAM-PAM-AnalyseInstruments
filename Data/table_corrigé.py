...
def table(medium_1=False,medium_2=False,metal=False,plexi = False):
    if medium_1 : 
       # masseT = 236e-3
        ...
        xinB = np.array([0.088747, 0.030742, 0.112417, 0.052442, 0.053975, 0.01313 ,0.042184, 0.06139 , 0.0375])#*1e-2
        # xinB = np.array([2.2,1.1,1.6,1.0,0.7,0.9,1.1,0.7,1.4])/100
    ...
    if medium_2 :
        ...
        xinB = np.array([0.112532, 0.228424, 0.054624, 0.143033, 0.05725 , 0.04318 , 0.066675, 0.065191, 0.03673])#*1e-2
    ...
    if metal : 
        ...
        xinB = np.array([0.063436, 0.060403, 0.041436, 0.041484, 0.021603, 0.034045, 0.047832, 0.039952, 0.040259])#*1e-2
    ...
    if plexi :
        ...
        xinB = np.array([0.071505, 0.037908, 0.038456, 0.040453, 0.013247, 0.020312,0.014682, 0.038635, 0.021269])#*1e-2
