...
def table(medium_1=False,medium_2=False,metal=False,plexi = False):
    if medium_1 : 
        ...
        0.05397483, 0.06034859, 0.06737623, 0.01312974])*1000
    ...
    if medium_2 :
        ...
        0.05724961, 0.05446982, 0.04318039, 0.05932118])*1000
    ...
    if metal : 
        ...
        0.02160338, 0.04902268, 0.04280855, 0.04109246])*1000
    ...
    if plexi :
        ...
        0.01324686, 0.03842954, 0.02031206, 0.02085583])*1000
